;;; workspaces.el --- Workspaces for Emacsen
;; Package-Version: 0.1
;; from http://www.emacswiki.org/emacs/workspaces.el
...
(defun workspace-init nil
  "List workspaces"
  (interactive)
  (message (concat "Workspaces list: " (mapconcat 'char-to-string (sort (copy-sequence workspaces-list) '<) ", "))))
